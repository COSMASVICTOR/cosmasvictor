...
private void groupButton() {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String myname = jTextField2.getText();
        ...
        String statement[] = {id, myname, gender, address, contact};
        ...
        try {
            ...
            String query = "insert into registration(id,myname,gender,address,contact) values(?,?,?,?,?)";
            PreparedStatement mydata = connect.prepareStatement(query);
            mydata.setString(1, id);
            mydata.setString(2, myname);
